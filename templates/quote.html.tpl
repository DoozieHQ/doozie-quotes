...
<body>
  ...
  <div class="wrap">
    ...
    <div class="section">
      ...
      <div class="viewer-wrap">
        ...
        <button class="fab-3d" id="open3dFullscreen" aria-label="Open 3D Viewer Fullscreen">⤢</button>
        <div class="fab-shield"></div>
      </div>
    </div>
  ...
  <div class="modal3d" id="modal3d" aria-hidden="true">
    ...
    <div class="modal3d-dialog">
      <button class="modal3d-close" id="close3dFullscreen">&times;</button>
  ...
  (function(){
    ...
    exit.addEventListener('click', hideLightbox);
    box.addEventListener('click', e => { if (e.target === box) hideLightbox(); });
