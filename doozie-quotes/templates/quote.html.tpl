...
<div class="header">
  <div class="header-inner">
    ...
    <div class="header-left">
      <img class="logo" src="/assets/Dark%20Grey%20Logo.png"/>
    </div>

    <div class="rev-badge">
      Quote • Lead {{LEAD_ID}} • Rev {{REVISION}}
    </div>
...
<div class="wrap">
  ...
  <div class="title-block">
    ...
    <div class="client-pill">Prepared for {{CLIENT_NAME}} • {{ISSUE_DATE}}</div>
  </div>
  ...
  <div class="section">
    ...
    <div class="meta-grid">
      <div><b>Lead ID</b></div><div>{{LEAD_ID}}</div>
      <div><b>Client</b></div><div>{{CLIENT_NAME}} &lt;{{CLIENT_EMAIL}}&gt;</div>
      <div><b>Valid Until</b></div><div>{{VALID_UNTIL}}</div>
      <div><b>Status</b></div><div>Draft</div>
    </div>
  </div>
